package com.example.teknologiinformasi.appointment_service.config;
...
public class AppointmentRabbitConfig {
    ...
    public static final String APPOINTMENT_QUEUE       = "appointment.updated.queue";
    public static final String APPOINTMENT_ROUTING_KEY = "appointment.updated";
